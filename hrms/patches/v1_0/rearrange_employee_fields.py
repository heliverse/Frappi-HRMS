	...
	custom_fields = {
		"Employee": [
			...
			# },
      		...
      		{
				"fieldname": "tuesday_shift",
				"fieldtype": "Link",
				"label": "Tuesday Shift",
				"options": "Shift Type",
				"insert_after": "monday_shift",
			},
            {
				"fieldname": "wednesday_shift",
				"fieldtype": "Link",
				"label": "Wednesday Shift",
				"options": "Shift Type",
				"insert_after": "tuesday_shift",
			},
            {
				"fieldname": "thursday_shift",
				"fieldtype": "Link",
				"label": "Thursday Shift",
				"options": "Shift Type",
				"insert_after": "wednesday_shift",
			},
            {
				"fieldname": "friday_shift",
				"fieldtype": "Link",
				"label": "Friday Shift",
				"options": "Shift Type",
				"insert_after": "thursday_shift",
			},
            {
				"fieldname": "saturday_shift",
				"fieldtype": "Link",
				"label": "Saturday Shift",
				"options": "Shift Type",
				"insert_after": "friday_shift",
			},
            {
				"fieldname": "sunday_shift",
				"fieldtype": "Link",
				"label": "Sunday Shift",
				"options": "Shift Type",
				"insert_after": "saturday_shift",
			},
			{
				"collapsible": 1,
